...
If multiple modules would result in the same name, [`output.devtoolFallbackModuleFilenameTemplate`](/en/config/output.html#devtoolfallbackmodulefilenametemplate) is used instead for these modules.
