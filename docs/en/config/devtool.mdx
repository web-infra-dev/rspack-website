...
`hidden` is used to control whether the end of the generated file contains the `# sourceMappingURL=... ` annotation, browser developer tools and VSCode etc. will look for the Source Map by the path or data url of this annotation in order to map the product's row number back to its location in the source code during debugging.

A more detailed look at devtool behavior can be found on the [webpack official site's introduction to devtool](https://webpack.js.org/configuration/devtool/#devtool).
