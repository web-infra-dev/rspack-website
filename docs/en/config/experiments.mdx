...
| rspackFuture                 | introduced version | default enabled version | removed version | description                                                                                                                                                                                                                                                                                     |
| ---------------------------- | ------------------ | ----------------------- | --------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| disableReactRefreshByDefault | v0.3.5             | -                       | -               | Control whether `@rspack/dev-server` turns on react refresh by default. In the early `@rspack/cli` design, react refresh was turned on by default in the dev server for out-of-the-box use in new projects, but this resulted in non-react projects needing to turn off react refresh manually. |
