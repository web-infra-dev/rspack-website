...
- implementation
  - Type: `string`
  - Usage: Provide a path as the implementation for Module Federation 1.5 runtime, which defaults to [@module-federation/webpack-bundler-runtime](https://github.com/module-federation/universe/tree/main/packages/webpack-bundler-runtime)。
- runtimePlugins
  - Type: `string[]`
