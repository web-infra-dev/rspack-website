...
- Using rspack's nodejs API, `stats.toJson(options)`、`stats.toString(options)`.

:::

<PropertyType type="boolean | string | Object" defaultValue="false" />
...
<PropertyType type="boolean" defaultValue="undefined" />
