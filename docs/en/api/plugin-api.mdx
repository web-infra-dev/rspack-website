...
Triggered before a module build has started, can be used to modify the module (Rspack currently only support read the module, modify is not supported yet).
