...
Rspack internally uses swc to perform code downgrade compilation, so there is no need to use babel-loader to perform code downgrade compilation.
...
It is planned to be supported, and it is expected to be completed in the next bi-month.
