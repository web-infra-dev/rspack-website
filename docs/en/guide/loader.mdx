...
You can use a custom loader with Rspack. In the example below, we'll use the loader to write a simple banner.

The purpose of this loader is to prepend a banner comment as the header of each module, for example a license notice:
