...
Rspack enables [Fast Refresh](https://reactnative.dev/docs/fast-refresh) functionality by default during development, allowing you to use it directly in your project. You can also disable the react-refresh feature through [builtins.react.react-refresh](config/builtins#builtinsreact).
