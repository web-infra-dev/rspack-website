...
Currently, Vue3 is supported by Rspack. Please make sure your [vue-loader](https://github.com/vuejs/vue-loader) version is >= 17.2.1 and configure as follows:
...
Rspack has completed compatibility with Vue2 (using vue-loader@15). Although it temporarily does not support using built-in TS, CSS features, you can still use style-loader and css-loader to generate styles.
...
You can refer to the related example [example-vue2](https://github.com/web-infra-dev/rspack/tree/main/examples/vue2).
