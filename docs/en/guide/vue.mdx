...
::: tip
Modern.js builder offers an out-of-the-box Vue3 and Vue2 solution. Related guides can be [referenced here](https://modernjs.dev/builder/guide/framework/vue3.html).
:::
