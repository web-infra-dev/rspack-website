...
::: tip
Modern.js builder offers an out-of-the-box Vue3 and Vue2 solution. Check out the guides for [Vue3](https://modernjs.dev/builder/guide/framework/vue3.html) or [Vue2](https://modernjs.dev/builder/guide/framework/vue2.html).
:::
