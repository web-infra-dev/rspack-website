...
:::warning Requirement for Rspack Version
To ensure the stability of the artifacts, please upgrade @rspack/cli or @rspack/core to v0.3.3 as soon as possible. [Details](https://github.com/web-infra-dev/rspack/issues/4003#issuecomment-1689662380)
:::
