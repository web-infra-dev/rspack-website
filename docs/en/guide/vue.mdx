...
::: tip
Modern.js offers an out-of-the-box Vue3 experience. Related examples can be [referenced here](https://modernjs.dev/builder/guide/framework/vue3.html).
:::
...
::: tip
Modern.js offers an out-of-the-box Vue2 experience. Related examples can be [referenced here](https://modernjs.dev/builder/guide/framework/vue2.html).
:::
