...
After ejecting the CRA is also considered a more complex webpack project configuration, the following lists the main things to do when migrating, the detailed code can be referred to [rspack-migration-showcase/pull/6](https://github.com/modern-js-dev/rspack-migration-showcase/pull/6)。
