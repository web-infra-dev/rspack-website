...
- Replaces the configuration that Rspack already has built-in support for
  ...
  - ReactRefreshWebpackPlugin has built-in support in Rspack and can be turned on or off with [builtins.react.refresh](config/builtins#config/builtins#reactoptions)
