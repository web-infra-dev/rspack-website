...
We have practiced esbuild internally on a large scale as a general purpose webapp builder, but it has some issues that make it difficult to meet our needs, such as
