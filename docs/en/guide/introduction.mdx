...
<div>
  ...
  <p style={{ display: 'inline' }}>
    ...
    <span>interoperability with the <a href="https://webpack.js.org/" target="_blank" rel="nofollow">webpack</a> ecosystem,</span>
...
Rspack has been under continuous development since April 2022, and was launched as open source in March 2023. Although the project is still in its early stages and lacks many webpack functionalities, based on the Pareto principle, we believe the current features can meet the needs of most businesses. Some ByteDance internal projects have already achieved a 5-10 times improvement moving from Webpack to Rspack, and there's still room for future optimizations.
