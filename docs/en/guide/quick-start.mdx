...
- If you're looking for a React framework to build a web application, you can try [Modern.js](https://modernjs.dev/en/).
...
Modern.js is a progressive React framework developed by ByteDance. It is based on Rspack and provides a complete solution for building web applications. Modern.js supports nested routes, server-side rendering, and provides out-of-the-box CSS solutions such as styled components and Tailwind CSS.

Learn more about Modern.js from the [official documentation](https://modernjs.dev/en/guides/get-started/introduction).
