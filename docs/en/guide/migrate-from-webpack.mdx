...
Rspack also supports JavaScript syntax downgrading by default. This means you don't need to use `babel-loader` to support browser compatibility anymore. Specify your browser compatibility via target as in this example:
