...
We are pleased to announce **the release of** **[Rsbuild](https://github.com/web-infra-dev/rsbuild)** **v0.1!** The milestone indicates that Rsbuild is stable enough to be used in a production environment.
...
We will be releasing the first working version of Rsbuild Doctor soon. Thereafter, Rsbuild will iterate in sync with Rspack, with plans to release version 1.0 in the first half of 2024.

Feel free to check out the [Rsbuild repository](https://github.com/web-infra-dev/rsbuild) to learn more about it 🙌.
...
In v0.4.0, Rspack deprecated some of the builtin options and migrated them to [internal plugins](/config/plugins.html#%E5%86%85%E9%83%A8%E6%8F%92%E4%BB%B6).
