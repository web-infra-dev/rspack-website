...
Some of the builtins options have been deprecated since v0.4.0, and they are removed in v0.5.0.
...
And if you are still using `builtins.presetEnv`, `builtins.decorator`, `builtins.pluginImport`, `builtins.emotion`, `builtins.relay`, checkout the migration guide [here](#add-configuration-for-old-transforming-related-builtins).
...
### Add configuration for old transforming related builtins
