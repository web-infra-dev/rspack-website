...
You can refer to the [examples/postcss-loader](https://github.com/web-infra-dev/rspack/blob/main/examples/postcss-loader/rspack.config.js) for a complete example.
