...
我们和 webpack 团队确立了合作关系，Rspack 作为 webpack 通过 Rust 进行性能优化的一个尝试，未来我们会和 webpack 团队一起探索优化 webpack 的更多的可能性，当 Rspack 达到一定的成熟度，webpack 将尝试以实验特性方式将 Rspack 集成到 webpack 中
