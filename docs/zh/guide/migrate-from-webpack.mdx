...
Rspack 同时还默认支持了 JavaScript 的语法降级功能，这意味着你不需要再使用 babel-loader 来支持浏览器兼容性，你可以通过 [target](/config/target) 和 [builtins.presetEnv](/config/builtins#builtinspresetenv) 来指定浏览器兼容性。
