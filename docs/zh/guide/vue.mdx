...
::: tip
Modern.js 提供了开箱即用的 Vue3 体验，相关示例可以[参考](https://modernjs.dev/builder/guide/framework/vue3.html)
:::
...
相关示例可以参考：[example-vue2](https://github.com/web-infra-dev/rspack/tree/main/examples/vue2) 和 [example-vue2-ts](https://github.com/web-infra-dev/rspack/tree/main/examples/vue2-ts)。

::: tip
Modern.js 提供了开箱即用的 Vue2 体验，相关示例可以[参考](https://modernjs.dev/builder/guide/framework/vue2.html)
:::
