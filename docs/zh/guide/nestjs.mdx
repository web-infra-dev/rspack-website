...
Rspack 不仅能用于构建前端应用，也可以用于构建 Node.js 应用，你可以使用 Rspack 来构建 NestJS，Rspack 提供了一个 [NestJS Example](https://github.com/web-infra-dev/rspack/tree/main/examples/nestjs) 的例子供参考。
