...
eject 后的 CRA 也算一个配置较为复杂的 webpack 项目，以下列举了迁移时主要做的几件事，详细的代码可以参考 [rspack-migration-showcase/pull/6](https://github.com/modern-js-dev/rspack-migration-showcase/pull/6)。
