...
- 通过 rspack 的 nodejs API，`stats.toJson(options)`、`stats.toString(options)`。

:::

<PropertyType.CN type="boolean | string | Object" defaultValue="false" />
...
<PropertyType.CN type="boolean" defaultValue="undefined" />
