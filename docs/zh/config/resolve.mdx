...
[点击查看例子](https://github.com/web-infra-dev/rspack/tree/main/examples/basic-ts)。
...
该配置需要开启 [`experiments.rspackFuture.newResolver`](/config/experiments.html#experimentsrspackfuturenewresolver).
