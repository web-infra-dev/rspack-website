...
| `test`      | `BannerConditions\|undefined` | undefined | 包含所有匹配的模块                             |
| `include`   | `BannerConditions\|undefined` | undefined | 根据条件匹配指定的模块                         |
| `exclude`   | `BannerConditions\|undefined` | undefined | 根据条件排除指定的模块                         |
