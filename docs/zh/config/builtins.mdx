...
配置项已经被废弃，并且将在版本 v0.5 被移除，请尽快迁移至 [`BannerPlugin`](/config/plugins.html#bannerplugin)。
...
配置项已经被废弃，在 v0.4 中默认将使用 [experiments.rspackFuture.disableTransformByDefault](/config/experiments.html#experimentsrspackfuturedisabletransformbydefault) 开启后的行为。
请尽快迁移至 [builtin:swc-loader 配置](https://www.rspack.dev/guide/loader.html#builtinswc-loader)。

如希望使用被废弃的行为，请确保[experiments.rspackFuture.disableTransformByDefault](/config/experiments.html#experimentsrspackfuturedisabletransformbydefault) 为关闭状态，这个配置项将在 v0.5 版本被完全移除。
...
配置项已经被废弃，并且将在版本 v0.5 被移除，请尽快迁移至 [`HtmlRspackPlugin`](/config/plugins.html#htmlrspackplugin)。
...
配置项已经被废弃，并且将在版本 v0.5 被移除，请尽快迁移至 [`SwcJsMinimizerRspackPlugin`](/config/plugins.html#swcjsminimizerrspackplugin)。
...
配置项已经被废弃，并且将在版本 v0.5 被移除，请尽快迁移至 [`DefinePlugin`](/config/plugins.html#defineplugin)。
...
配置项已经被废弃，并且将在版本 v0.5 被移除，请尽快迁移至 [`ProgressPlugin`](/config/plugins.html#progressplugin)。
...
配置项已经被废弃，并且将在版本 v0.5 被移除，请尽快迁移至 [`CopyRspackPlugin`](/config/plugins.html#copyrspackplugin)。
...
配置项已经被废弃，并且将在版本 v0.5 被移除，请尽快迁移至 [`ProvidePlugin`](/config/plugins.html#provideplugin)。
