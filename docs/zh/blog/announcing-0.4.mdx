...
欢迎查看 [Rsbuild 仓库](https://github.com/web-infra-dev/rsbuild) 以了解更多信息 🙌。
...
2. [target](https://www.rspack.dev/config/target)(https://www.rspack.dev/config/target) 不再降级用户端代码（包含 node_modules）
