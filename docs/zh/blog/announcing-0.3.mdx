...
Rspack 在 0.2 提供了对 `vue-loader` 的支持,但是基于 `vue-loader` 封装一套完整的 Vue.js cli 的解决方案是一个较为复杂工作，`Modern.js Builder` 提供了 Vue.js 的开箱即用的工程化方案 [Modern.js Vue.js Support](https://modernjs.dev/builder/guide/framework/vue3.html) 来简化使用 Rspack 开发 Vue.js 的工作。
