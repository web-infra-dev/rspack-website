...
如果你正在使用 `builtins.noEmitAssets`, `builtins.devFriendlySplitChunks`, `builtins.html`, `builtins.copy`, `builtins.minifyOptions`，请查看[这篇文档](https://www.rspack.dev/zh/blog/announcing-0-4#%E8%BF%81%E7%A7%BB-builtin-options-%E5%88%B0-builtin-plugins)并进行迁移。

而如果你正在使用 `builtins.presetEnv`, `builtins.decorator`, `builtins.react`, `builtins.pluginImport`, `builtins.emotion`, `builtins.relay`, 请查看[这篇文档](#%E6%B7%BB%E5%8A%A0%E9%80%82%E7%94%A8%E4%BA%8E%E6%97%A7%E7%89%88-builtin-%E8%BD%AC%E6%8D%A2%E7%9A%84%E7%9B%B8%E5%90%8C%E9%85%8D%E7%BD%AE%E6%96%87%E4%BB%B6)并进行迁移。
...
在将 `@rspack/core` 升级到 v0.5.0 后，如果构建失败并出现错误：`Failed to resolve ./src/xxx.tsx`，或者 `Failed to resolve ./src/xxx.ts`，或者 `Failed to resolve ./src/xxx.jsx`，则需要在配置中添加 `resolve.extensions = ['...', '.tsx', '.ts', '.jsx']`。
