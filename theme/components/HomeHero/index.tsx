...
//   return (
//     <div className="m-auto px-6 pb-12 sm:pt-0 sm:px-8  md:px-16 md:pb-16">
//       {/* <div
...
//         }}
//       ></div> */}
//       <div className="max-w-1152px m-auto flex flex-col">
...
//           {hero.text?.length && (
//             <p
//               className={`pb-2 mx-auto md:m-0 text-3xl sm:text-5xl md:text-6xl font-bold z-10`}
...
//         {hasImage ? (
//           <div className="modern-doc-home-hero-image m-auto flex-center md:none lg:flex">
